...
export default function Team() {
    return (
        <div className="flex flex-col h-screen items-center">
            ...
            <div className="w-full h-1 bg-gradient-to-r from-transparent via-[#0e2e76] to-transparent mt-20"></div>

            <div className="grid grid-cols-2 md:grid-cols-6 gap-3 mt-20">
